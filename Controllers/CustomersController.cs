...
namespace GoodLuck.Controllers
{
    ...
    {
        private GoodLuckEntities db = new GoodLuckEntities();
        ...
        public async Task<ActionResult> Create([Bind(Include = "Name,Address1,Address2,Pincode,City,State,Phone,Mobile,GSTNO,ContactPerson", Exclude = "Id,AddedBy,AddedOn")] Customer customer)
        {
